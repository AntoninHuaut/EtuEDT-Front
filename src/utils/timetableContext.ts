...
export function createTimetableContext(
	params: Record<string, unknown>,
): ITimetableContext | undefined {
	...
	if (
		...
		!isResourceType(params.resourceType)
	) {
		return undefined;
	}
...
export function isGroupMissingForTimetable(params: {
	...
	return (
		params.resourceType === "timetable" &&
		toNumber(params.groupId) === undefined
	);
}
